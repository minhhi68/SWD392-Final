...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public static String TBL_BANCHITIET = "BANCHITIET";
    ...
    public static String TBL_BAN_ID_MANV = "MANV";

    public static String TBL_BAN_NGAYDAT = "NGAYDAT";
    ...
    //id bàn,id người đặt,ngày đặt
    //idBanCHiTiet
    public static String TBL_CHITIETDATBAN_ID = "ID";
    public static String TBL_CHITIETDATBAN_MABAN = "MABAN";
    public static String TBL_CHITIETDATBAN_MANV = "MANV";
    public static String TBL_CHITIETDATBAN_NGAYDAT = "NGAYDAT";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tblBAN = "CREATE TABLE " +TBL_BAN+ " ( " +TBL_BAN_MABAN+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
                +TBL_BAN_TENBAN+ " TEXT, " +TBL_BAN_TINHTRANG+ " TEXT, " +TBL_BAN_ID_MANV+ " INTEGER, "+TBL_BAN_NGAYDAT+ " TEXT)";
        ...
        String tblCHITIETBANDAT = "CREATE TABLE " +TBL_BANCHITIET+  " ( " +TBL_CHITIETDATBAN_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
                +TBL_CHITIETDATBAN_MABAN+ " INTEGER, " +TBL_CHITIETDATBAN_MANV+ " INTEGER, " +TBL_CHITIETDATBAN_NGAYDAT+ " TEXT )";
