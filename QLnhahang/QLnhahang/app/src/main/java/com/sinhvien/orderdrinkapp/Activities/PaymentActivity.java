    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_payment_ThanhToan:
                boolean cnttb = banAnDAO.CapNhatTinhTrangBan(maban, "false");
                boolean utttmb = donDatDAO.UpdateTThaiDonTheoMaBan(maban, "true");
                boolean uttdd = donDatDAO.UpdateTongTienDonDat(madondat, String.valueOf(tongtien));
                if (cnttb && utttmb && uttdd) {
