...
import com.sinhvien.orderdrinkapp.Fragments.DisplayTableNoticeFragment;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_order:
                //hiển thị tương ứng trên navigation
                FragmentTransaction tranDisplayTableNotice = fragmentManager.beginTransaction();
                DisplayTableNoticeFragment displayTableNoticeFragment = new DisplayTableNoticeFragment();
                tranDisplayTableNotice.replace(R.id.contentView, displayTableNoticeFragment);
                tranDisplayTableNotice.commit();
                navigationView.setCheckedItem(item.getItemId());
                drawerLayout.closeDrawers();
                break;
